...
function slider(root, data, DPI_WIDTH) {
  ...
  function mouseDown(event) {
    ...
    if (type === 'window') {
      ...
      document.onmousemove = function (e) {
        ...
        var right = WIDTH - left - defaultWidth;
...
function chart(root, data) {
  ...
  (0, _slider.slider)(root.querySelector('[data-el="slider"]'), data, DPI_WIDTH);
  var ctx = canvas.getContext('2d');
  var raf;
  canvas.width = DPI_WIDTH;
  canvas.height = DPI_HEIGHT;
  ...
  function xAxis(xRatio, xData, yData) {
    var colsCount = 6;
...
},{"./styles/index.scss":"styles/index.scss","./utils":"utils.js","./tooltip":"tooltip.js","./slider":"slider.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var _chart = (0, _chart2.chart)(document.getElementById('chart'), (0, _data.getChartData)()),
    init = _chart.init;

init();
},{"./data/data":"data/data.js","./chart":"chart.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
